                ...
                <div class="row py-4 g-3">
                    @foreach ($comics as $comic)
                        <div class="col-6 col-md-4 col-lg-3 col-xl-2 d-flex flex-column align-items-center">
                            <div class="show-element img-container position-relative" data-element-id="{{ $comic->id }}">
                                <img src="{{ $comic->thumb }}" alt="{{ $comic->series }}">
                                <div
                                    class="img-hover justify-content-center align-items-center position-absolute top-0 end-0 bottom-0 start-0">
                                </div>
                            </div>
